 ...
 * (1.7.5)
 *
 * j'ai utilisé la drupal_set_message()fonction globale pour économiser de l'espace. Vous devez plutôt injecter le Messengerservice pour imprimer des messages à l'utilisateur.
 */
