...
/**
 * (entity 1)
 *  définitions de type d'entité
 *
 * apres cree entity 4.3 si le module est active (drush entity-updates).
 */
...
class Product extends ContentEntityBase implements ProductInterface {
  ...
  /**
   * pour gérer le changedchamp et implémenter des getters et setters simples pour les valeurs trouvées dans les champs que nous avons définis comme champs de base.
   *
