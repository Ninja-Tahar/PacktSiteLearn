...
/**
 * (entity 2)
 * contiendra toutes les méthodes utilisées pour accéder aux valeurs de champ pertinentes.
 */

namespace Drupal\products\Entity;

use Drupal\Core\Entity\ContentEntityInterface;
use Drupal\Core\Entity\EntityChangedInterface; // qui fournit quelques méthodes pratiques pour gérer la dernière date de modification des entités. Ces implémentations de méthode seront ajoutés à notre Productclasse via leEntityChangedTrait
