<?php
/**
 * (Le plugin Importer 1)
 *
 * À l'intérieur de la getData() méthode, nous récupérons les informations produit de la ressource distante. Nous le faisons en obtenant l'URL de l' Importerentité de configuration
 * et en utilisant Guzzle pour faire une demande à cette URL. Nous nous attendons à ce que ce soit du JSON, nous le décodons donc comme tel. Bien sûr, la gestion des erreurs est
 * pratiquement inexistante dans cet exemple, et ce n'est pas bon.
 *
 ...
 * Si le produit existe déjà, nous vérifions d'abord si le rselon la configuration, nous pouvons le mettre à jour et ne le faisons que si cela nous le permet.
